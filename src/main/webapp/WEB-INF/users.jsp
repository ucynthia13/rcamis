	...
	<div id="layout" class="container" style="padding-top: 16px; ">
		<div id="banner">
			...
			<div class="right" style="text-align: right; ">
				<c:if test="${authenticatedUser !=null}">
					...
					<b> <a
						href="listuser.php?page=profile&&id=${authenticatedUser.id}"><button class="btn btn-link">Profile
		...
		<div id="middle">
			<c:if test="${authenticatedUser !=null}">
				...
				<form action="listuser.php?page=statusapproval" method="post" class="form-group">
